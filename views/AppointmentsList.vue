...
export default {
  ...
  methods: {
    fetchAppointments() {
      fetch("https://ytqkg1qjl6.execute-api.us-east-1.amazonaws.com/stage01/Appointment")
        .then(res => res.json())
        .then(data => {
    ...
    updateStatus(appointment, newStatus) {
      ...
      const url = `https://ytqkg1qjl6.execute-api.us-east-1.amazonaws.com/stage01/Appointment/${appointment.appointmentId}`;
